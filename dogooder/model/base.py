...
from sqlalchemy.ext.declarative.api \
    import declared_attr, has_inherited_table, declarative_base
...
class _Base_(object):
    ...
    see: http://docs.sqlalchemy.org/en/rel_0_7/orm/extensions/declarative.html#augmenting-the-base  # noqa
    """
